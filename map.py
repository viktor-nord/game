...
class Map:
    ...
    def blit_all_tiles(self, screen):
        ...
        #     if col.is_polygon:
        #         for dot in col.dots:
        #             s = pygame.Surface((dot.width, dot.height)).convert()
        #             s.fill((255,0,0))
        #             screen.blit(s, (dot.x, dot.y))
        #     else:
        #         s = pygame.Surface((col.rect.width, col.rect.height))
        #         s.fill((255,0,0))
        #         screen.blit(s, (col.rect.x, col.rect.y))
